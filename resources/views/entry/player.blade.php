        ...
        @csrf
            ...
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="team" class="w-auto py-2 border border-gray-300 rounded-md" id="team" value="{{ old('team') }}">
                </div>
            </div>
            ...
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="position" class="w-auto py-2 border border-gray-300 rounded-md" id="position" value="{{ old('position') }}">
                </div>
            </div>
            ...
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="detail" class="w-auto py-2 border border-gray-300 rounded-md" id="detail" value="{{ old('detail') }}">
                </div>
            </div>
