    ...
    <section class="profile">
        ...
        <div class="profiletext">
            ...
            <ul class="text">
                ...
                <li>Birthplace: 宮崎</li>
                <li>Hobby: サーフィン・野球・ゴルフ・ボウリング</li>
                <li>-Workhistory-<br>　高校卒業後、千葉の総合化学メーカーに入社をし、化学プラントオペレーターとして5年間従事してきました。その中で、実際に制作物がユーザーにどのように使われているかなどが分かるプログラマーに魅力を感じ、プログラマーになるための基礎を学ぶことができるライブビジネススクールに入校し、基本情報技術者試験の勉強やHTML.CSS.PHPのプログラミング言語を学んできました。</li>
            </ul>
        </div>
    </section>
    ...
    <section class="skills">
        ...
        <div class="skilltext">
            ...
            <ul class="text">
                ...
                <li>-ビジョン-<br>　私は将来、お客様の課題解決や業務改善・効率化、そしてお客様に喜んでもらえるようなシステムを作成することができるプログラマーになりたいと考えています。そのようなプログラマーになるためにも、変化が著しいこのIT業界で固定概念にとらわれず、新しい知識をインプットできるよう柔軟な考えを常に心がけたいと考えています。そしていずれは、プロジェクトの管理や編成を行うことができるディレクター職になりたいと考えています。</li>
            </ul>
        </div>
    </section>
</body>
